...
export default function OperationsDashboardPage() {
  ...
  const operationsLinks = [
    ...
    { title: "الورديات", description: "جدولة ورديات العمل", href: "/shift-management", icon: Clock, count: stats?.todayShifts || 0, countLabel: "وردية" },
  ...
  const quickActions = [
    ...
    { label: "وردية جديدة", href: "/shift-management", icon: Clock },
