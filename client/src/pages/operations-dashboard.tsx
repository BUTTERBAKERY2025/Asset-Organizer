...
export default function OperationsDashboardPage() {
  ...
  const operationsLinks = [
    ...
    { title: "الورديات والحضور", description: "إدارة الورديات وتسجيل الحضور", href: "/attendance-dashboard", icon: Clock, count: stats?.todayShifts || 0, countLabel: "وردية", highlight: true },
  ...
  const quickActions = [
    ...
    { label: "الحضور والورديات", href: "/attendance-dashboard", icon: Clock },
