...
export default function MarketingDashboardPage() {
  ...
  const quickAccessCards = [
    { title: "الحملات", href: "/marketing-campaigns", icon: Megaphone, color: "bg-amber-500", count: allCampaigns.length },
    { title: "المؤثرين", href: "/marketing-influencers", icon: Users, color: "bg-blue-500", count: allInfluencers.length },
    { title: "التقويم", href: "/marketing-calendar", icon: Calendar, color: "bg-purple-500", count: calendarEvents.length },
    { title: "المهام", href: "/marketing-tasks", icon: Target, color: "bg-orange-500", count: allTasks.length },
    { title: "التقارير", href: "/marketing-reports", icon: FileBarChart, color: "bg-green-500", count: null },
    { title: "الفريق", href: "/marketing-team", icon: TrendingUp, color: "bg-indigo-500", count: teamMembers.length },
    { title: "الأهداف", href: "/marketing-goals", icon: Award, color: "bg-rose-500", count: null },
    { title: "المصروفات", href: "/marketing-expenses", icon: DollarSign, color: "bg-emerald-500", count: null },
    { title: "التنبيهات", href: "/marketing-alerts", icon: Bell, color: "bg-red-500", count: null },
    { title: "الأصول", href: "/marketing-assets", icon: FolderOpen, color: "bg-cyan-500", count: null },
  ];
  ...
  return (
    <Layout>
      <div className="space-y-6" dir="rtl">
        ...
        {/* Quick Access */}
        <div>
          <h2 className="text-base font-semibold mb-3">الوصول السريع</h2>
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
            {quickAccessCards.map((card, index) => (
              <Link key={index} href={card.href}>
                <Card className="group hover:shadow-md transition-all duration-200 cursor-pointer border hover:border-primary/30 h-full">
