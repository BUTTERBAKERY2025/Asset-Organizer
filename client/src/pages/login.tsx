...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-stone-900 via-stone-800 to-amber-900">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-0 w-[300px] sm:w-[400px] lg:w-[600px] h-[300px] sm:h-[400px] lg:h-[600px] bg-amber-500/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/4"></div>
        <div className="absolute bottom-0 left-0 w-[200px] sm:w-[300px] lg:w-[400px] h-[200px] sm:h-[300px] lg:h-[400px] bg-amber-600/10 rounded-full blur-3xl translate-y-1/2 -translate-x-1/4"></div>
        <div className="absolute top-1/2 left-1/2 w-[150px] sm:w-[200px] lg:w-[300px] h-[150px] sm:h-[200px] lg:h-[300px] bg-orange-500/5 rounded-full blur-2xl -translate-x-1/2 -translate-y-1/2"></div>
      </div>
      ...
      <div className="relative z-10 bg-stone-900/95 backdrop-blur-sm border-t border-stone-800">
