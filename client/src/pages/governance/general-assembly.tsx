          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="col-span-2">
              ...
              <div className="flex flex-wrap gap-2">
                <label className="flex items-center gap-2 px-3 py-2 border rounded-lg bg-green-50 border-green-200 cursor-pointer text-sm">
                  <Checkbox
                    id="sendWhatsApp"
                  ...
                  <span className="text-green-700">واتساب</span>
                </label>
                <label className="flex items-center gap-2 px-3 py-2 border rounded-lg bg-blue-50 border-blue-200 cursor-pointer text-sm">
                  <Checkbox
                    id="sendEmail"
                  ...
                  <span className="text-blue-700">إيميل</span>
                </label>
                <label className="flex items-center gap-2 px-3 py-2 border rounded-lg bg-purple-50 border-purple-200 cursor-pointer text-sm">
                  <Checkbox
                    id="sendSMS"
                  ...
                  <span className="text-purple-700">SMS</span>
                </label>
              </div>
              <p className="text-xs text-gray-500 mt-2">
                سيتم إرسال الدعوة إلى {shareholders.filter(s => s.votingRights).length} مساهم
              </p>
            </div>
          </div>
