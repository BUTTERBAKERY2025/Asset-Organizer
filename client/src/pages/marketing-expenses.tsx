    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          >
            <SelectTrigger className="h-11 sm:h-10" data-testid="select-expense-campaign">
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger className="h-11 sm:h-10" data-testid="select-expense-category">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger className="h-11 sm:h-10" data-testid="select-expense-status">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          >
            <SelectTrigger className="h-11 sm:h-10" data-testid="select-expense-influencer">
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger className="h-11 sm:h-10" data-testid="select-expense-payment-method">
