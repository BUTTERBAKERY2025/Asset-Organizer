...
import { 
  ...
  Sparkles, Crown, Handshake, DoorOpen, Bell, Store, ShieldAlert, MessageCircle, MessageSquareWarning, LayoutGrid, Camera, UserCircle
} from "lucide-react";
...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  const ROUTE_TO_GROUP: Record<string, string> = useMemo(() => ({
    "/hr-hub": "hr", "/branch-employees": "hr", "/terminated-employees": "hr",
    ...
    "/hr/advances": "hr", "/hr/eos": "hr", "/hr/evaluations": "hr", "/hr-cashier-deficits": "hr",
    ...
    "/cashier-shift-performance": "sales", "/pnl-dashboard": "sales",
    ...
    "/backups": "settings", "/catalogue-import": "settings", "/notifications-management": "settings", "/notifications-center": "settings",
  }), []);
  ...
  const allNavGroups: { key: string; group: NavGroup }[] = useMemo(() => [
    {
      ...
      group: {
        ...
        items: [
          ...
          { href: "/biometric-settings", label: t("sidebar.biometricSettings"), icon: ShieldAlert, module: "biometric_settings", indent: true, adminOnly: true },
          ...
          { href: "/hr/applications", label: t("sidebar.employmentApplications"), icon: UserCheck, module: "hr_employment_applications", indent: true },
          { href: "/hr/job-offers", label: t("sidebar.jobOffers"), icon: Briefcase, module: "hr_job_offers", indent: true },
          { href: "/hr/onboarding", label: t("sidebar.onboarding"), icon: ClipboardCheck, module: "hr_onboarding", indent: true },
          { href: "/hr/employee-documents", label: t("sidebar.employeeDocuments"), icon: FileText, module: "hr_documents", indent: true },
          { href: "/hr/leaves", label: t("sidebar.leaves"), icon: Calendar, module: "hr_leaves", indent: true },
          { href: "/hr/warnings", label: t("sidebar.warnings"), icon: ShieldAlert, module: "hr_warnings", indent: true },
          { href: "/hr/advances", label: t("sidebar.advances"), icon: Gift, module: "hr_advances", indent: true },
          { href: "/hr/eos", label: t("sidebar.endOfService"), icon: FileBarChart, module: "hr_eos", indent: true },
          { href: "/hr/evaluations", label: t("sidebar.evaluations"), icon: ClipboardCheck, module: "hr_evaluations", indent: true },
          { href: "/hr-cashier-deficits", label: t("sidebar.cashierDeficits"), icon: Wallet, module: "hr_advances", indent: true },
          { href: "/floor-plan", label: t("sidebar.floorPlan"), icon: LayoutGrid, module: "floor_plan", indent: true },
        ],
      },
    },
    {
      ...
      group: {
        ...
        items: [
          ...
          { href: "/kitchen-warehouse-shipping", label: "شحن المنتجات للمستودعات", icon: Boxes, module: "production", indent: true },
    ...
    },
    {
      ...
      group: {
        ...
        items: [
          ...
          { href: "/contractor-statements", label: t("sidebar.contractorStatements"), icon: Receipt, module: "contractor_statements", indent: true },
          { href: "/contractor-oversight", label: t("sidebar.contractorOversight"), icon: ShieldAlert, module: "contracts", indent: true },
          { href: "/construction/daily-logs", label: t("sidebar.dailyLogs"), icon: ClipboardList, module: "project_daily_logs", indent: true },
          { href: "/field-hub", label: t("sidebar.fieldHub"), icon: MapPin, module: "construction_projects", indent: true },
          { href: "/field-checklists/templates", label: t("sidebar.fieldChecklists"), icon: ClipboardCheck, module: "construction_projects", indent: true },
    ...
    },
    {
      ...
      group: {
        ...
        items: [
          ...
          { href: "/marketing-opening-campaigns", label: t("sidebar.openingCampaigns"), icon: Gift, module: "marketing", indent: true },
          { href: "/marketing-media-team", label: t("sidebar.mediaTeam"), icon: Camera, module: "marketing", indent: true },
          ...
          { href: "/loyalty-campaigns", label: t("sidebar.loyaltyCampaigns"), icon: Gift, module: "marketing", indent: true, adminOnly: true },
    ...
    },
    {
      ...
      group: {
        ...
        items: [
          ...
          { href: "/kitchen-warehouse-shipping", label: "استلام منتجات المطبخ", icon: Boxes, module: "warehouse", indent: true },
    ...
    },
    {
      ...
      group: {
        ...
        items: [
          ...
          { href: "/executive/templates", label: t("sidebar.executiveTemplates"), icon: FileText, module: "executive_dashboard", indent: true },
      ...
      group: {
        ...
        items: [
          ...
          { href: "/backups", label: t("sidebar.backups"), icon: HardDrive, module: "backups", indent: true },
           { href: "/catalogue-import", label: "اعتماد كتالوج الأصناف", icon: PackageCheck, module: "settings", indent: true, adminOnly: true },
          ...
          { href: "/notifications-center", label: t("sidebar.notificationsCenter"), icon: MessageCircle, module: "settings", indent: true, adminOnly: true },
        ],
      },
    },
  ], [t, user?.role]);
