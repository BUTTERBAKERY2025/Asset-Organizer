  ...
  const allNavGroups: { key: string; group: NavGroup }[] = [
    {
      ...
      group: {
        ...
        items: [
          ...
          { href: "/assets-dashboard", label: "لوحة تحكم المعدات والأصول", icon: LayoutDashboard, module: "inventory" },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      group: {
        ...
        items: [
          ...
          { href: "/cashier-shift-performance", label: "أداء الشفتات والكاشير", icon: TrendingUp, module: "operations" },
