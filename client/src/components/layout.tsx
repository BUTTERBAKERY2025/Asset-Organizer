    ...
    },
    {
      ...
      group: {
        ...
        items: [
          ...
          { href: "/executive/calendar", label: t("sidebar.executiveCalendar", "التقويم"), icon: Calendar, indent: true },
          { href: "/executive/meetings", label: t("sidebar.executiveMeetings", "الاجتماعات"), icon: Users, indent: true },
