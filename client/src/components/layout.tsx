  ...
  const allNavGroups: { key: string; group: NavGroup }[] = useMemo(() => [
    {
      ...
      group: {
        ...
        items: [
          ...
          { href: "/biometric-settings", label: "إعدادات البصمة", icon: ShieldAlert, module: "biometric_settings", indent: true, adminOnly: true },
          ...
          { href: "/hr/applications", label: "طلبات التوظيف", icon: UserCheck, module: "hr_employment_applications", indent: true },
          { href: "/hr/job-offers", label: "عروض العمل", icon: Briefcase, module: "hr_job_offers", indent: true },
          { href: "/hr/onboarding", label: "مباشرة العمل", icon: ClipboardCheck, module: "hr_onboarding", indent: true },
          { href: "/hr/employee-documents", label: "وثائق الموظفين", icon: FileText, module: "hr_documents", indent: true },
          { href: "/hr/leaves", label: "طلبات الإجازات", icon: Calendar, module: "hr_leaves", indent: true },
          { href: "/hr/warnings", label: "الإنذارات والمخالفات", icon: ShieldAlert, module: "hr_warnings", indent: true },
          { href: "/hr/advances", label: "السلف والقروض", icon: Gift, module: "hr_advances", indent: true },
          { href: "/hr/eos", label: "نهاية الخدمة", icon: FileBarChart, module: "hr_eos", indent: true },
