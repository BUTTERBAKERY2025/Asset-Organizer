...
export const INVENTORY_DATA: BranchData[] = [
  ...
  },
  {
    ...
    name: "فرع تبوك",
    inventory: [
      { id: "t-1", name: "الكمرات", quantity: 16, unit: "حبة", category: "أثاث وعام" },
      { id: "t-2", name: "السماعات", quantity: 7, unit: "حبة", category: "أثاث وعام" },
      { id: "t-3", name: "المظلات", quantity: 6, unit: "حبة", category: "أثاث وعام" },
      { id: "t-4", name: "حوض زرع", quantity: 37, unit: "حبة", category: "أثاث وعام" },
      { id: "t-5", name: "دفايا مربعة", quantity: 6, unit: "حبة", category: "أثاث وعام" },
      { id: "t-6", name: "دفاية غاز طويلة", quantity: 5, unit: "حبة", category: "أثاث وعام" },
      { id: "t-7", name: "نافورة موية صغيرة", quantity: 6, unit: "حبة", category: "أثاث وعام" },
      { id: "t-8", name: "كرسي حديد مجدول", quantity: 53, unit: "حبة", category: "أثاث وعام" },
      { id: "t-9", name: "طاولة دائرية طويلة", quantity: 14, unit: "حبة", category: "أثاث وعام" },
      { id: "t-10", name: "طاولة دائرية قصيرة", quantity: 8, unit: "حبة", category: "أثاث وعام" },
      { id: "t-11", name: "نافورة كبيرة", quantity: 1, unit: "حبة", category: "أثاث وعام" },
      { id: "t-12", name: "لوحة بتر بيكري", quantity: 2, unit: "حبة", category: "أثاث وعام" },
      { id: "t-13", name: "لوحة المدخل صغيرة وكبيرة", quantity: 2, unit: "حبة", category: "أثاث وعام" },
      { id: "t-14", name: "كاونتر خدمة", quantity: 2, unit: "حبة", category: "أثاث وعام" },
      { id: "t-15", name: "ثلاجة تبريد 2 باب", quantity: 5, unit: "حبة", category: "المطبخ" },
      { id: "t-16", name: "فرن يونكس مع الخمارة", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-17", name: "فرن يونكس مع الخمارة", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-18", name: "ترولي", quantity: 3, unit: "حبة", category: "المطبخ" },
      { id: "t-19", name: "فرن بيتزا غاز", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-20", name: "ثلاجة كاونتر تبريد دريسنج 3 باب", quantity: 2, unit: "حبة", category: "المطبخ" },
      { id: "t-21", name: "ثلاجة كاونتر تبريد 2 باب", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-22", name: "ثلاجة فريزر 1 باب", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-23", name: "ثلاجة كاونتر تبريد 4 باب", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-24", name: "ماكينة غسيل", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-25", name: "سلمندر", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-26", name: "حامل بهارات", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-27", name: "ثلاجة فريزر كبيرة", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-28", name: "عجانة 60 لتر", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-29", name: "مكسر حلويات كبير", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-30", name: "رف حائط", quantity: 4, unit: "حبة", category: "المطبخ" },
      { id: "t-31", name: "فرادة عجين", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-32", name: "طاولة استيل 3 رف", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-33", name: "طاولة استيل 1 رف", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-34", name: "حافظة طحين كبيرة", quantity: 4, unit: "حبة", category: "المطبخ" },
      { id: "t-35", name: "حافظة طحين صغيرة", quantity: 6, unit: "حبة", category: "المطبخ" },
      { id: "t-36", name: "حامل استيل كبير 4 رف", quantity: 2, unit: "حبة", category: "المطبخ" },
      { id: "t-37", name: "حامل استيل صغير 4 رف", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-38", name: "ماكينة قهوة لامرزوكا استراد", quantity: 1, unit: "حبة", category: "باريستا" },
      { id: "t-39", name: "طاحونة اسبريسو", quantity: 2, unit: "حبة", category: "باريستا" },
      { id: "t-40", name: "تمير اسبريسو", quantity: 1, unit: "حبة", category: "باريستا" },
      { id: "t-41", name: "حامل اكواب", quantity: 2, unit: "حبة", category: "باريستا" },
      { id: "t-42", name: "موازين v60", quantity: 5, unit: "حبة", category: "باريستا" },
      { id: "t-43", name: "سيرفر v60", quantity: 4, unit: "حبة", category: "باريستا" },
      { id: "t-44", name: "طاحونة قهوة مقطرة", quantity: 2, unit: "حبة", category: "باريستا" },
      { id: "t-45", name: "ماكينة برتقال", quantity: 1, unit: "حبة", category: "باريستا" },
      { id: "t-46", name: "ايس ميكر كبير وصغير", quantity: 2, unit: "حبة", category: "باريستا" },
      { id: "t-47", name: "فلتر كامل مع الخزان", quantity: 1, unit: "حبة", category: "باريستا" },
      { id: "t-48", name: "باسكت", quantity: 1, unit: "حبة", category: "باريستا" },
      { id: "t-49", name: "ثلاجة عرض 3 باب", quantity: 1, unit: "حبة", category: "باريستا" },
      { id: "t-50", name: "رينزر", quantity: 1, unit: "حبة", category: "باريستا" },
      { id: "t-51", name: "ماكينة قهوة اليوم (فيتكو)", quantity: 1, unit: "حبة", category: "باريستا" },
      { id: "t-52", name: "حافظة مشروبات ساخنة", quantity: 2, unit: "حبة", category: "باريستا" },
      { id: "t-53", name: "ماكينة هوت شوكليت", quantity: 1, unit: "حبة", category: "باريستا" },
      { id: "t-54", name: "خلاط استيل", quantity: 1, unit: "حبة", category: "باريستا" },
      { id: "t-55", name: "جريل", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-56", name: "فرن بوتجاز 4 عين", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-57", name: "سلايزر", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-58", name: "خلاط عادي", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-59", name: "ثلاجة عرض صغيرة", quantity: 1, unit: "حبة", category: "باريستا" },
      { id: "t-60", name: "ثلاجة عرض طويلة", quantity: 1, unit: "حبة", category: "باريستا" },
      { id: "t-61", name: "سلم 2 درج", quantity: 1, unit: "حبة", category: "أثاث وعام" },
      { id: "t-62", name: "حوض غسيل استيل", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-63", name: "طاولة استيل 4 رف", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-64", name: "ستائر هواء", quantity: 2, unit: "حبة", category: "أثاث وعام" },
      { id: "t-65", name: "مكسر حلويات", quantity: 2, unit: "حبة", category: "المطبخ" },
      { id: "t-66", name: "فرن تسخين مايكرويف", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-67", name: "اير برش", quantity: 1, unit: "حبة", category: "المطبخ" },
      { id: "t-68", name: "ميزان", quantity: 2, unit: "حبة", category: "المطبخ" },
      { id: "t-69", name: "مكبس كريمات وصوصات", quantity: 2, unit: "حبة", category: "المطبخ" },
      { id: "t-70", name: "طاولة خدمة بيضاء", quantity: 1, unit: "حبة", category: "أثاث وعام" },
      { id: "t-71", name: "كرسي جلد", quantity: 14, unit: "حبة", category: "أثاث وعام" },
      { id: "t-72", name: "كرسي داخلي خشب", quantity: 13, unit: "حبة", category: "أثاث وعام" },
      { id: "t-73", name: "كرسي خشب منجد صغير", quantity: 12, unit: "حبة", category: "أثاث وعام" },
      { id: "t-74", name: "طاولة دائرية خشب داخلية", quantity: 3, unit: "حبة", category: "أثاث وعام" },
      { id: "t-75", name: "طاولة خشب دائرية مربعة", quantity: 4, unit: "حبة", category: "أثاث وعام" },
      { id: "t-76", name: "طاولة خشب دائرية صغيرة", quantity: 4, unit: "حبة", category: "أثاث وعام" },
      { id: "t-77", name: "مرآة كبيرة مع لوجو", quantity: 1, unit: "حبة", category: "أثاث وعام" },
      { id: "t-78", name: "طاولة شيرينج طويلة", quantity: 1, unit: "حبة", category: "أثاث وعام" },
      { id: "t-79", name: "كنب جلد داخلي", quantity: 4, unit: "حبة", category: "أثاث وعام" },
      { id: "t-80", name: "فخار كبير", quantity: 2, unit: "حبة", category: "أثاث وعام" },
      { id: "t-81", name: "فخار وسط", quantity: 3, unit: "حبة", category: "أثاث وعام" },
      { id: "t-82", name: "فخار صغير", quantity: 10, unit: "حبة", category: "أثاث وعام" },
      { id: "t-83", name: "فخار صغير XS", quantity: 7, unit: "حبة", category: "أثاث وعام" },
      { id: "t-84", name: "كنب جلسة 2 حبة", quantity: 16, unit: "حبة", category: "أثاث وعام" },
    ]
  }
];
