const pageImports: Record<string, () => Promise<any>> = {
  ...
  "catalogue-import": () => import("@/pages/catalogue-import"),
  ...
  "kitchen-warehouse-shipping": () => import("@/pages/kitchen-warehouse-shipping"),
  "warehouse-dashboard": () => import("@/pages/warehouse-dashboard"),
  "reverse-logistics": () => import("@/pages/reverse-logistics"),
  ...
  "audit-portal": () => import("@/pages/audit-portal"),
...
const ADJACENT_PAGES: Record<string, string[]> = {
  ...
  "/settings": ["security-management", "rbac-management", "users", "catalogue-import"],
...
const ROUTE_TO_PAGE: Record<string, string> = {
  ...
  "/central-kitchen-orders": "central-kitchen-orders",
  "/central-kitchen-recipes": "central-kitchen-recipes",
  ...
  "/kitchen-warehouse-shipping": "kitchen-warehouse-shipping",
